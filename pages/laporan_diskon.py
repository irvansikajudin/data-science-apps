...
st.markdown("""
    <iframe width="800" height="500" src="https://datastudio.google.com/embed/reporting/9dcdf68c-e3f8-4b57-a402-530b9298906c/page/AiB1C" frameborder="0" style="border:0" allowfullscreen></iframe>
